...
public class PasswordEvaluator {
	...
	public static String evaluatePassword(String input) {
		...
		String errMessage = "";
		if (!foundUpperCase)
			errMessage += "At least one upper case letter - not yet satisfied\n";
		
		if (!foundLowerCase)
			errMessage += "At least one lower case letter - not yet satisfied\n";
		
		if (!foundNumericDigit)
			errMessage += "At least one numeric digit - not yet satisfied\n";
			
		if (!foundSpecialChar)
			errMessage += "At least one special character - not yet satisfied\n";
			
		if (!foundLongEnough)
			errMessage += "At least eight characters - not yet satisfied\n";
