...
public class SetupAccountPage {
    ...
    public void show(Stage primaryStage) {
        ...
        setupButton.setOnAction(a -> {
            ...
            String passErr = PasswordEvaluator.evaluatePassword(password);
            ...
            try {
            	...
            	if(!databaseHelper.doesUserExist(userName)) {
            		...
            		} else if(databaseHelper.validateInvitationCode(code)) { //If password is fine, validate the new invite code
